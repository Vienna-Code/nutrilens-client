		...
		<div className={styles.review} key={id}>
			<div className={styles.user}>
				<div className={styles.profilePic}>
					<img src={reviewUser.profilePicture ? `/api/images/${reviewUser.profilePicture}` : `https://ui-avatars.com/api/?name=${reviewUser.username}&background=3b9c6a&color=1c1c1c&size=48&font-size=0.35&uppercase=true`} alt="" />
				</div>
