		...
		<div className={styles.comment}>
			<div className={styles.userInfo}>
				<div className={styles.profilePic} onClick={() => navigate(`~/user/${user.id}`)}>
					<img src={user.profilePicture ? `/api/images/${user.profilePicture}` : `https://ui-avatars.com/api/?name=${user.username}&background=3b9c6a&color=1c1c1c&size=48&font-size=0.35&uppercase=true`} alt="" />
				</div>
